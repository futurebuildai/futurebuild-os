...
4. **Execute**: Assume the role of the **Product Orchestrator** and follow the instructions in the SKILL file.
   - **You must** create an `implementation_plan.md` and `task.md` that explicitly lists which sub-skills (UX, Accessibility, Security, Compliance) will be used for each section.
